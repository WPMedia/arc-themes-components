...
** Portrait Picture Source for mobile, landscape Picture Image for desktop **

`Picture.Source` may be used to explicitly target Art Direction requirements for specific viewport widths.

<Canvas>
	<Story name="Portrait Picture Source for mobile, landscape Picture Image for desktop">
		<Picture>
			<Picture.Source
				src="HY6LDPEW4BBFDLBYD4S3S7LZ3E.jpg"
				height={1500}
