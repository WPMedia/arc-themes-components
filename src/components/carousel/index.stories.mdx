...
The Carousel component exposes all the React Slick properties as well as two properties (`className` and `children`) that
are explicitly for the Carousel component.
...
<Canvas>
	<Story name="Single Item With Dots">
		...
		>
			<Carousel dots slidesToShow={1} slidesToScroll={1} initialSlide={0} centerMode={false}>
				<SampleCard src="https://loremflickr.com/400/300" />
				<SampleCard src="https://baconmockup.com/400/300" />
				<SampleCard src="https://www.placecage.com/400/300" />
				<SampleCard src="http://placeimg.com/400/300/any" />
