...
| name    | description                                                    | element                | CSS Variables |
| ------- | -------------------------------------------------------------- | ---------------------- | ------------- |
| heading | Header tag that will show hierarchy based on heading container | h1, h2, h3, h4, h5, h6 |               |

Set default value of color for all components heading
...
Set heading component color value for a block with token `story-card`
